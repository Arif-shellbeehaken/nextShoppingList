...
import { BsFillTrashFill, BsHeart, BsHeartFill, BsWrench } from 'react-icons/bs';
import {
  Button,
  Card,
  CardBody,
...
const ShoppingCard = () => {
  const {
    ...
    handleDelete,
    handleReaction,
    logedEmail} = useShoppingListHook();
                ...
                <Link href={`/item/edit-item/${item._id}`}>
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    >
                      ...
                      <span className="fs-6 text-dark">{item.likes.length}</span>
                    </Button>
                  </div>
                </div>
            </Card>
